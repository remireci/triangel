...
const Welcome = () => {
  ...
  return (
    <div>
      <div className='flex flex-row lg:mt-44 bg-[#87bdd8]'>
        <div className='w-0 md:w-1/5 lg:w-1/5'></div>
        <div className='flex flex-col justify-between w-full md:w-3/5 lg:w-2/5 h-86 -mb-4 lg:-mb-10  mt-20 px-6 py-6 text-base bg-[#daebe8] rounded shadow'>
          <h1 className='text-lg text-center font-bold tracking-widest mb-8'>
            Gratis online loopbaantest
          </h1>
      ...
      {/* <div className='flex flex-row h-fit pb-36 text-slate-600'> */}
